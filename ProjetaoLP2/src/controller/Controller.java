...
import exceptions.NomeInvalidaException;
...
public class Controller {
	...
	public void realizaLogin(String matricula, String senha) throws Exception{
	...
	public boolean cadastraFuncionario(String nome, String cargo, String dataNascimento) throws Exception{
		Funcionario funcionario = null;
		if (nome.equalsIgnoreCase("")){
			throw new NomeInvalidaException();
		}
	...
	public Funcionario verificaFuncionario(String matricula) throws Exception{
